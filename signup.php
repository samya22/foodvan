...
if(!isset($_SESSION['access_token']))
{
 ...
 $login_button = '
   <button onclick="window.location.href=\'' . $auth_url . '\'" title="Sign In" type="button" class="sign-in_ggl">
...
.sign-in_btn:hover {
  background-color:rgb(132, 224, 86);
}
...
<div class="form_container">
  ...
  <div class="input_container">
    ...
    <input placeholder="name@gmail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="password" autocomplete="new-password" type="password" class="input_field" id="password_field">
  </div>
  <div class="input_container">
    <label class="input_label" for="password_field">Password</label>
    <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
    ...
    <input placeholder="Confirm Password" title="Inpit title" name="confirm-pass" type="password" class="input_field" id="password_field">
  </div>

  <span class="subtitle" id="warn2" style="color:red; display:none;"><i class="fa-solid fa-triangle-exclamation"></i> Please Enter Correct Details !</span>
...
<?php
    ...
    if (isset($_SESSION['warningsignup']) && $_SESSION['warningsignup'] == true) { 
      echo "<script>
